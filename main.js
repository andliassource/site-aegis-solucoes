document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    pt: {
      meta: {
        title: 'Aegis Solucoes | ERP/CRM 360 com 47 rotas e 143+ modulos enterprise',
        description:
          'Aegis Solucoes: ERP/CRM 360 com 47 rotas canonicas e 143+ modulos enterprise para operacao, governanca, BI e IA aplicada ao contexto empresarial.',
        ogTitle: 'Aegis Solucoes | ERP/CRM 360 com 47 rotas e 143+ modulos enterprise',
        ogDescription: 'Gestao empresarial integrada com dashboard central, governanca e camadas reais de negocio.',
        twitterTitle: 'Aegis Solucoes | ERP/CRM 360 com 47 rotas e 143+ modulos enterprise',
      ...
      text: {
        ...
        'hero.lead':
          'A documentacao do produto registra 47 rotas canonicas no app principal, 143+ modulos enterprise e um dashboard que agrega KPIs de vendas e finanças em uma visao 360.',
        ...
        'hero.proof2': '47 rotas canonicas no app principal',
        'hero.proof3': '143+ modulos enterprise em camadas de negocio',
        'stats.modules': 'rotas canonicas e modulos enterprise documentados',
        ...
        'modules.scopeTitle': '47 rotas canonicas e 143+ modulos enterprise',
        'modules.scopeDesc': 'A comunicacao agora espelha a documentacao do produto: core, CRM, finance, operations, HR, GRC, IT e system, com dashboard central como ponto de entrada.',
        ...
        'cta.desc': 'Podemos evoluir com versao institucional + versao por segmento + paginas por dominio.',
        'cta.openApp': 'Abrir aplicacao',
        'footer.copy': 'Aegis Solucoes © 2026. ERP/CRM 360 com 47 rotas canonicas e 143+ modulos enterprise.',
        'footer.home': 'Inicio',
    ...
    en: {
      meta: {
        title: 'Aegis Solutions | 360 ERP/CRM with 47 routes and 143+ enterprise modules',
        description:
          'Aegis Solutions: 360 ERP/CRM with 47 canonical routes and 143+ enterprise modules for operations, governance, BI, and AI applied to business context.',
        ogTitle: 'Aegis Solutions | 360 ERP/CRM with 47 routes and 143+ enterprise modules',
        ogDescription: 'Integrated business management with a central dashboard, governance, and real business layers.',
        twitterTitle: 'Aegis Solutions | 360 ERP/CRM with 47 routes and 143+ enterprise modules',
      ...
      text: {
        ...
        'hero.lead':
          'The product documentation records 47 canonical routes in the main app, 143+ enterprise modules, and a dashboard that aggregates sales and finance KPIs in a 360 view.',
        'hero.ctaPrimary': 'See platform',
        'hero.ctaSecondary': 'Explore modules',
        'hero.proof1': 'Main dashboard with KPIs and recent activity',
        'hero.proof2': '47 canonical routes in the main app',
        'hero.proof3': '143+ enterprise modules across business layers',
        'stats.modules': 'documented canonical routes and enterprise modules',
        ...
        'modules.scopeTitle': '47 canonical routes and 143+ enterprise modules',
        'modules.scopeDesc': 'The messaging now mirrors the product docs: core, CRM, finance, operations, HR, GRC, IT, and system, with the dashboard as the entry point.',
        ...
        'cta.desc': 'We can evolve with institutional version + segment pages + domain-specific pages.',
        'cta.openApp': 'Open application',
        'footer.copy': 'Aegis Solutions © 2026. 360 ERP/CRM with 47 canonical routes and 143+ enterprise modules.',
        'footer.home': 'Home',
